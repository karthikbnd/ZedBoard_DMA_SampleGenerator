...
HD_PWD='C:/Users/kab/Desktop/workspace/ZedBoard_DMA_SampleGenerator/ZedBoard_DMA_SampleGenerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_dma_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_dma_wrapper.tcl
