...
HD_PWD='C:/Users/kab/Desktop/workspace/ZedBoard_DMA_SampleGenerator/ZedBoard_DMA_SampleGenerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_dma_wrapper.tcl -notrace
